...
from payload.openstack.common import eventlet_backdoor
...
from payload.openstack.common import threadgroup


rpc = importutils.try_import('payload.openstack.common.rpc')
CONF = cfg.CONF
