...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/payload/sqlite.db",
        sqlite_db="/var/lib/payload/sqlite.db")
...
from payload.openstack.common.db import exception
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside payload
            index = file.rfind('payload')
            if index == -1:
                continue
